 ...
 *-------------------------------------------------------------------------*/
int FFT2D(double _Complex *c, int nl, int nc, int dir)
{
    int i, j;
    int m, twopm;
    double *real, *imag;
...
void filtro(double _Complex *img, int nl, int nc)
{
    ...
    for (i = 0; i < nl; i++)
        for (j = 0; j < nc; j++)
        {
            ...
            if(j > nc / 2 - 22 && j < nc / 2 - 20){
                if(i > nl / 2 - 18 && i < nl / 2 - 6)
                    img[i * nc + j] = 0;
            }

            if(j > nc / 2 - 27 && j < nc / 2 - 15){
                if(i > nl / 2 - 13 && i < nl / 2 - 11)
                    img[i * nc + j] = 0;
            }    


            //Ponto superior direito
            if(j > nc / 2 + 41 && j < nc / 2 + 44){
                if(i > nl / 2 - 31 && i < nl / 2 - 18)
                    img[i * nc + j] = 0;
            }            

            if(j > nc / 2 + 36 && j < nc / 2 + 49){
                if(i > nl / 2 - 26 && i < nl / 2 - 23)
                    img[i * nc + j] = 0;
            }


            //Ponto inferior direito
            if(j > nc / 2 + 20 && j < nc / 2 + 22){
                if(i > nl / 2 + 6 && i < nl / 2 + 18)
                    img[i * nc + j] = 0;
            }

            if(j > nc / 2 + 15 && j < nc / 2 + 27){
                if(i > nl / 2 + 11 && i < nl / 2 + 13)
                    img[i * nc + j] = 0;
            }


            //Ponto inferior esquerdo
            if(j > nc / 2 - 44 && j < nc / 2 - 41){
                if(i > nl / 2 + 18 && i < nl / 2 + 31)
                    img[i * nc + j] = 0;
            }

            if(j > nc / 2 - 49 && j < nc / 2 - 36){
                if(i > nl / 2 + 23 && i < nl / 2 + 26)
                    img[i * nc + j] = 0;
            }

            //Linhas laterais
            if (i > nl / 2 - 3 && i < nl / 2 - 1)
                if (j < nc / 2 - 20 || j > nc / 2 + 20)
                    img[i * nc + j] = 0;

            if (i > nl / 2 + 1 && i < nl / 2 + 3)
                if (j < nc / 2 - 20 || j > nc / 2 + 20)
                    img[i * nc + j] = 0;
